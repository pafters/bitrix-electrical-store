...
$executeNew = static function () use ($checkResult, $findNew, $getHighloadBlock): void {
...
<div>
    ...
    <ol>
        ...
        <li>
            ...
            <input id="newPhp" readonly size="70"
...
<div class="adm-detail-toolbar">
    <?php if (null !== $listUrl) { ?>
        <a class="adm-detail-toolbar-btn" href="<?php echo html($listUrl); ?>"
